...
class arifle_XMS_Shot_Gray_lxWS
{
	model="XMS_lxWS";
	camo="Gray";
	attachment="UBSG";
...
class arifle_XMS_Shot_Camo_lxWS
{
	model="XMS_lxWS";
	camo="Stripes";
	attachment="UBSG";
